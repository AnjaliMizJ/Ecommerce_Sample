...
public class Single_view_Adapter extends RecyclerView.Adapter<Single_view_Adapter.MyViewHolder> {
    ...
    public Single_view_Adapter(Context context, List<Model_home_recycle> data) {
    ...
    @Override
    public Single_view_Adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view=inflater.inflate(R.layout.activity_model_home_recycle, parent, false);
        Single_view_Adapter.MyViewHolder holder=new Single_view_Adapter.MyViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(final Single_view_Adapter.MyViewHolder holder, final int position) {
